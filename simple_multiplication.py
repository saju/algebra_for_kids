...
#
# python2 simple_multiplication.py
#
# Generates 10 questions of the form Ny = M, where both N & M are small numbers.
# 
# How I use this program..
# python2 simple_multiplication.py > qns_plus_answers.txt
